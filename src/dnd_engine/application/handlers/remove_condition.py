...
class RemoveConditionHandler:
    ...
    def handle(
        self, command: RemoveConditionCommand
    ) -> ResolutionResult[ConditionRemovalResult]:
            ...
            return ResolutionResult(
                ...
                errors=(
                    EngineError(
                        ...
                        message="Condition removal actor was not found.",
        ...
        if target is None:
            return ResolutionResult(
                ...
                errors=(
                    EngineError(
                        code=ErrorCode.ENTITY_NOT_FOUND,
                        message="Condition removal target was not found.",
        ...
        outcome = resolve_condition_removal(command, target)
